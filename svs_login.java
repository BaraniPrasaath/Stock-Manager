...
class svs_login extends Frame implements FocusListener, ActionListener
{

	svs_dataRetrive ojt = new svs_dataRetrive();

String nameFinal="",passwordFinal="";
int count=0;
...
{
String signal=ojt.userVerification(nameFinal,passwordFinal);
...
if(ae.getSource()==b3)
{
//JOptionPane.showMessageDialog(null,"Technical Issues you can't create a new account");
new svs_newlogin();
}
